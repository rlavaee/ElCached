...
#else
void rd_trace_get(const char * key, size_t nkey, uint64_t hv);
void rd_trace_set(const char * key, size_t nkey, uint64_t hv, unsigned slabs_clsid, int nbytes);
void rd_trace_set_chunk_size(unsigned slabs_clsid, unsigned size);
