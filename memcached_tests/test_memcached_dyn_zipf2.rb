...
#prof_lens = (warmup_len*8..trace_len).step(warmup_len*2).to_a
prof_lens = [warmup_len*8]
...
prof_lens.each do |prof_len|
   ...
   stdin, stdout, stderr, wait_th = Open3.popen3({"PROF_LEN" => prof_len.to_s, "WARMUP_LEN" => warmup_len.to_s}, "/home/rlavaee/memcached-dyn/memcached  -m #{mem} -o slab_reassign -p 11212")
	 ...
	 Open3.popen3("./mutilate --noload --binary -s 127.0.0.1:11212 -K fb_key -V fb_value -i fb_ia -T 4  -N zipfian:1.15,4000 -r 4000 -t 30000 -n #{total_trace_len} -L 1") do |_stdin, _stdout, _stderr, _wait_th|
