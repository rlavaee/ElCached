...
static void server_stats(ADD_STAT add_stats, conn *c) {
    ...
    if (settings.slab_reassign) {
        ...
        APPEND_STAT("slabs_moved", "%llu", stats.slabs_moved);
				APPEND_STAT("slabs_removed", "%llu", stats.slabs_removed);
    }
...
bool is_monitoring_slabs(void){ return monitoring_slabs;}
void set_monitoring_slabs(bool val){	monitoring_slabs=val;}
