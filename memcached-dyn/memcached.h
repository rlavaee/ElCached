...
struct stats {
    ...
    uint64_t      slabs_moved;       /* times slabs were moved around */
		uint64_t			slabs_removed;     /* times slabs were removed */
...
//rlavaee
void set_slab_active(item *, const uint32_t hv);
bool is_monitoring_slabs(void);
void set_monitoring_slabs(bool val);
