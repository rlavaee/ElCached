...
public:
  ...
  virtual bool handle_response(evbuffer* input, bool &done, char * keystr, bool &missed) = 0;
...
public:
  ...
  virtual bool handle_response(evbuffer* input, bool &done, char * keystr, bool &missed){return false;};
...
public:
  ...
  virtual int  set_request(const char* key, const char* value, int len);
  virtual bool handle_response(evbuffer* input, bool &done);
  virtual bool handle_response(evbuffer* input, bool &done, char * keystr, bool &missed);
};
